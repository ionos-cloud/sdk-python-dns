...
class KeyParameters(BaseModel):
    ...
    ksk_bits: Optional[KskBits] = Field(default=None, alias="kskBits")
    zsk_bits: Optional[ZskBits] = Field(default=None, alias="zskBits")
    __properties: ClassVar[List[str]] = ["algorithm", "kskBits", "zskBits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kskBits": obj.get("kskBits"),
            "zskBits": obj.get("zskBits")
        })
        return _obj
