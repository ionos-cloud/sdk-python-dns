...
class RecordReadList(BaseModel):
    """
    RecordReadList
    """ # noqa: E501
    ...
    items: Optional[List[RecordRead]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "href": obj.get("href"),
            "items": [RecordRead.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
